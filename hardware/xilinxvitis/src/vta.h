...
#ifndef _XILINXVITIS_VTA_H_
#define _XILINXVITIS_VTA_H_
...
#define PORT_LEN                (VTA_BLOCK_IN * 8)
#define BIASE_MAX_BURST         (16)
#define MAX_BUS_WIDTH           (512)
#define INT_READ_FACTOR         (MAX_BUS_WIDTH / 32)
#define CHAR_RAED_FACTOR        (MAX_BUS_WIDTH / 8)
#define INT_SIZE                (32)
#define CHAR_SIZE               (8)
